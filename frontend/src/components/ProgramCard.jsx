  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center text-xs text-slate-600 bg-gray-50 p-2.5 rounded-lg border border-gray-100 group-hover:bg-white group-hover:border-blue-100 transition-colors">
